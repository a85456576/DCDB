    ...
    <div class="modal-body">
        <form wire:submit.prevent='add'>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="title" wire:model="title" placeholder="أدخل اسم الملاحظة" >
            </div>
            <!-- حقل محتوى الملاحظة -->
            <div class="mb-3">
                <label for="content" class="form-label">محتوى الملاحظة</label>
                <textarea class="form-control" id="content" wire:model="content" rows="5" placeholder="أدخل محتوى الملاحظة" ></textarea>
            </div>
